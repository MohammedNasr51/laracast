            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <!-- here we use a function and some condition to make the syle of nav bar dynamic -->
                        
                        <a href="/laracast/"
                            class="<?= urlis('/laracast/') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium"
